...
@Component(immediate = true, property = { "com.liferay.portlet.display-category=Fihoca",
...
public class Portlet1Portlet extends MVCPortlet {
	...
	static {
		...
		facturaNetflix.put("num", "2018/01");
		facturaNetflix.put("cliente", "Netflix");
		facturaNetflix.put("importe", "8.000");
	...
	public void serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		resourceResponse.addProperty(HttpHeaders.CONTENT_DISPOSITION, "attachmente: filename=listado.csv");
